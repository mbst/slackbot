...
//
JiraProvider.prototype.requestWithAuth(path, type) {
    var defer = Q.defer();
    if (!_.isString(path)) {
...
//  
JiraProvider.prototype.getFeature(featureId) {
    var defer = Q.defer();
    ...
    this.requestWithAuth(_endpoint+issueID).then(function(featuredata) {
